...
/* XPM */
static const char* closed_xpm[]={//文件夹图标,通过QPixmap类映射的固定值
    "15 15 6 1",
    ". c None",
    "b c #ffff00",
    "d c #000000",
...
/* XPM */
static const char* file_xpm[]={//文件图标,通过QPixmap类映射的固定值
    "13 15 5 1",
    ". c #7f7f7f",
    "# c None",
    "c c #000000",
...
FtpView::FtpView( QWidget *parent )
    : QListView( parent )
{
    addColumn( trUtf8( "文件名" ) );
    addColumn( trUtf8( "大小 KB" ) );
    addColumn( trUtf8( "最后更改的时间" ) );
